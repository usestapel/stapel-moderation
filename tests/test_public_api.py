...
class TestLazyExports:
    ...
    def test_settings_resolve(self):
        ...
        assert stapel_moderation.moderation_settings is moderation_settings

    def test_unknown_attribute_raises(self):
        try:
            stapel_moderation.nonexistent_export
...
class TestImportWithoutDjangoSettings:
    def test_package_import_is_django_free(self):
        """`import stapel_moderation` must not import Django nor require settings."""

# Contributing to stapel-moderation
...
```bash
git clone https://github.com/usestapel/stapel-moderation.git && cd stapel-moderation
...
- **No new hardcoded behavior.** Anything a host project might want to
  ...
  (`STAPEL_MODERATION` dict; see `conf.py`) — with a dotted-path
